...
@section('title', 'Movimiento de Equipos')
@section('page-title', 'Movimiento de Equipos')
...
async function buscarEquipo() {
    ...
    try {
        const response = await fetch('{{ route("movimientos.buscar-equipo") }}', {
            method: 'POST',
            headers: {
...
async function buscarEquipoRemplazo() {
    ...
    try {
        const response = await fetch('{{ route("movimientos.buscar-equipo-remplazo") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
...
async function buscarTiendaAgregar() {
    ...
    try {
        const response = await fetch('{{ route("movimientos.buscar-tienda") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
...
async function guardarMovimiento() {
    ...
    if (crActual) {
        try {
            const response = await fetch('{{ route("movimientos.validar-inventario") }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
...
async function guardarMovimientoFinal(formData) {
    try {
        const response = await fetch('{{ route("movimientos.guardar") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
...
function irACapturaInventario() {
    ...
    window.location.href = '{{ route("inventario.captura") }}?cr=' + crActual;
}
