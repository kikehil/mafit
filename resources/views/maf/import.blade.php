...
@section('title', 'Nueva Importación MAF')
...
<div class="bg-white shadow rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="mb-6 space-y-4">
            ...
            <div class="p-4 bg-green-50 border border-green-200 rounded-lg">
                <div class="flex items-center justify-between">
                    ...
                    <a 
                        href="{{ route('maf.import.template') }}" 
        ...
        <form action="{{ route('maf.import.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end space-x-4">
                <a href="{{ route('maf.batches.index') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancelar
                </a>
                <button 
                    type="submit" 
