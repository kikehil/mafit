...
@section('title', 'Captura Inventario PSF')
@section('page-title', 'Captura Inventario PSF')

@section('content')
<div class="min-h-screen bg-gray-50 pb-8">
    <div class="max-w-4xl mx-auto px-4 py-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Captura de Inventario PSF - {{ $plazaUsuario }}</h2>
...
function buscarEquipo() {
    ...
    fetch('{{ route("inventario-psf.buscar-equipo") }}', {
        method: 'POST',
        headers: {
...
document.getElementById('formCaptura').addEventListener('submit', function(e) {
    ...
    fetch('{{ route("inventario-psf.guardar") }}', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '{{ csrf_token() }}'
        },
