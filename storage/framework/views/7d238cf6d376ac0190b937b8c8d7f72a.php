...
<?php $__env->startSection('title', 'Inventarios Realizados'); ?>
<?php $__env->startSection('page-title', 'Inventarios Realizados'); ?>
...
function buscarTiendas() {
    ...
    fetch('<?php echo e(route("inventario.obtener-tiendas-realizados")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WEB\MAFIT\resources\views/inventario/realizados.blade.php ENDPATH**/ ?>