...
<?php $__env->startSection('title', 'Consulta Inventario PFS'); ?>
<?php $__env->startSection('page-title', 'Consulta Inventario PFS'); ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="resultadosBody" class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50" data-equipo-id="<?php echo e($equipo->id); ?>">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($equipo->placa ?? '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($equipo->serie ?? '-'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($equipo->activo ?? '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <select 
                                    ...
                                    data-equipo-id="<?php echo e($equipo->id); ?>"
                                    data-ubicacion-actual="<?php echo e($equipo->ubicacion ?? ''); ?>"
                                >
                                    <option value="BODEGA" <?php echo e(($equipo->ubicacion ?? '') == 'BODEGA' ? 'selected' : ''); ?>>BODEGA</option>
                                    <option value="PS ERICK" <?php echo e(($equipo->ubicacion ?? '') == 'PS ERICK' ? 'selected' : ''); ?>>PS ERICK</option>
                                    <option value="PS OSCAR" <?php echo e(($equipo->ubicacion ?? '') == 'PS OSCAR' ? 'selected' : ''); ?>>PS OSCAR</option>
                                    <option value="PS ALFREDO" <?php echo e(($equipo->ubicacion ?? '') == 'PS ALFREDO' ? 'selected' : ''); ?>>PS ALFREDO</option>
                                    <option value="PS ROBERTO1" <?php echo e(($equipo->ubicacion ?? '') == 'PS ROBERTO1' ? 'selected' : ''); ?>>PS ROBERTO1</option>
                                    <option value="PS ROBERTO 2" <?php echo e(($equipo->ubicacion ?? '') == 'PS ROBERTO 2' ? 'selected' : ''); ?>>PS ROBERTO 2</option>
                                    <option value="PS SAMUEL" <?php echo e(($equipo->ubicacion ?? '') == 'PS SAMUEL' ? 'selected' : ''); ?>>PS SAMUEL</option>
                                    <option value="OFF. VALLES" <?php echo e(($equipo->ubicacion ?? '') == 'OFF. VALLES' ? 'selected' : ''); ?>>OFF. VALLES</option>
                                    <option value="OFF TAMPICO" <?php echo e(($equipo->ubicacion ?? '') == 'OFF TAMPICO' ? 'selected' : ''); ?>>OFF TAMPICO</option>
                                </select>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($equipo->created_at ? $equipo->created_at->format('d/m/Y H:i') : '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <button 
                                    onclick="abrirModalBaja(<?php echo e($equipo->id); ?>, '<?php echo e($equipo->placa ?? ''); ?>')"
            ...
            <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1 flex justify-between sm:hidden">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e($equipos->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Anterior
                        </a>
                        <?php endif; ?>
                        
                        <?php if($equipos->hasMorePages()): ?>
                        <a href="<?php echo e($equipos->nextPageUrl()); ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Siguiente
                        </a>
                        <?php else: ?>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Mostrando
                                <span class="font-medium"><?php echo e($equipos->firstItem()); ?></span>
                                a
                                <span class="font-medium"><?php echo e($equipos->lastItem()); ?></span>
                                de
                                <span class="font-medium"><?php echo e($equipos->total()); ?></span>
                                resultados
                            </p>
                        </div>
                        <div>
                            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                ...
                                <?php else: ?>
                                <a href="<?php echo e($equipos->previousPageUrl()); ?>" class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                                    <span class="sr-only">Anterior</span>
                                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
                                ...
                                <?php $__currentLoopData = $equipos->getUrlRange(1, $equipos->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($page == $equipos->currentPage()): ?>
                                ...
                                <?php if($equipos->hasMorePages()): ?>
                                <a href="<?php echo e($equipos->nextPageUrl()); ?>" class="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
...
function actualizarUbicacion(equipoId, ubicacion, selectElement) {
    fetch(`<?php echo e(url('inventario-psf')); ?>/${equipoId}/ubicacion`, {
        method: 'PUT',
        headers: {
...
function filtrarEquipos() {
    ...
    const url = new URL('<?php echo e(route("inventario-psf.obtener-equipos")); ?>', window.location.origin);
...
function confirmarBaja() {
    ...
    fetch(`<?php echo e(url('inventario-psf')); ?>/${equipoIdBaja}/dar-de-baja`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WEB\MAFIT\resources\views/inventario-pfs/consulta.blade.php ENDPATH**/ ?>