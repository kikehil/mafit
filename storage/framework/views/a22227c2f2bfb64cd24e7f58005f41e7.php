...
<head>
    ...
    <title><?php echo e(config('app.name', 'MAFIT')); ?> - <?php echo $__env->yieldContent('title', 'Sistema de Control de Activos Fijos'); ?></title>
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 text-white transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 shadow-2xl">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
                    ...
                    <?php if($isAdmin || in_array('dashboard', $userModules)): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/25' : 'text-slate-400 hover:bg-white/5 hover:text-white'); ?>">
                        <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('dashboard') ? 'text-white' : 'text-slate-500 group-hover:text-blue-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if($isAdmin || in_array('inventario.captura', $userModules) || in_array('inventario.consulta', $userModules) || in_array('inventario.realizados', $userModules)): ?>
                    <div class="space-y-1 pt-2">
                        <button id="inventario-toggle" class="w-full flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 group <?php echo e(request()->routeIs('inventario.*') ? 'bg-white/5 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-white'); ?>">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('inventario.*') ? 'text-blue-400' : 'text-slate-500 group-hover:text-blue-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                                </svg>
                                <span class="font-medium">Inventario</span>
                            </div>
                            <svg class="w-4 h-4 transition-transform duration-200 <?php echo e(request()->routeIs('inventario.*') ? 'rotate-90 text-blue-400' : 'text-slate-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </button>
                        <div id="inventario-submenu" class="<?php echo e(request()->routeIs('inventario.*') ? '' : 'hidden'); ?> space-y-1">
                            <?php if($isAdmin || in_array('inventario.captura', $userModules)): ?>
                            <a href="<?php echo e(route('inventario.captura')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('inventario.captura') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('inventario.captura') ? 'bg-blue-400' : 'bg-slate-600'); ?>"></span>
                                Captura Inventario
                            </a>
                            <?php endif; ?>
                            <?php if($isAdmin || in_array('inventario.consulta', $userModules)): ?>
                            <a href="<?php echo e(route('inventario.consulta')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('inventario.consulta') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('inventario.consulta') ? 'bg-blue-400' : 'bg-slate-600'); ?>"></span>
                                Consulta Inventario
                            </a>
                            <?php endif; ?>
                            <?php if($isAdmin || in_array('inventario.realizados', $userModules)): ?>
                            <a href="<?php echo e(route('inventario.realizados')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('inventario.realizados') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('inventario.realizados') ? 'bg-blue-400' : 'bg-slate-600'); ?>"></span>
                                Realizados
                            </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <?php if($isAdmin || in_array('inventario-psf.captura', $userModules) || in_array('inventario-psf.consulta', $userModules) || in_array('inventario-psf.movimientos', $userModules)): ?>
                    <div class="space-y-1 pt-2">
                        <button id="inventario-psf-toggle" class="w-full flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 group <?php echo e(request()->routeIs('inventario-psf.*') ? 'bg-white/5 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-white'); ?>">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('inventario-psf.*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-indigo-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                                <span class="font-medium">Inventario PFS</span>
                            </div>
                            <svg class="w-4 h-4 transition-transform duration-200 <?php echo e(request()->routeIs('inventario-psf.*') ? 'rotate-90 text-indigo-400' : 'text-slate-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </button>
                        <div id="inventario-psf-submenu" class="<?php echo e(request()->routeIs('inventario-psf.*') ? '' : 'hidden'); ?> space-y-1">
                            <?php if($isAdmin || in_array('inventario-psf.captura', $userModules)): ?>
                            <a href="<?php echo e(route('inventario-psf.captura')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('inventario-psf.captura') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('inventario-psf.captura') ? 'bg-indigo-400' : 'bg-slate-600'); ?>"></span>
                                Captura PFS
                            </a>
                            <?php endif; ?>
                            <?php if($isAdmin || in_array('inventario-psf.consulta', $userModules)): ?>
                            <a href="<?php echo e(route('inventario-psf.consulta')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('inventario-psf.consulta') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('inventario-psf.consulta') ? 'bg-indigo-400' : 'bg-slate-600'); ?>"></span>
                                Consulta PFS
                            </a>
                            <?php endif; ?>
                            <?php if($isAdmin || in_array('inventario-psf.movimientos', $userModules)): ?>
                            <a href="<?php echo e(route('inventario-psf.movimientos')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('inventario-psf.movimientos') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('inventario-psf.movimientos') ? 'bg-indigo-400' : 'bg-slate-600'); ?>"></span>
                                Movimientos PFS
                            </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <?php if($isAdmin || in_array('movimientos.index', $userModules) || in_array('movimientos.consulta', $userModules)): ?>
                    <div class="space-y-1 pt-2">
                         <div class="px-4 py-2">
                            <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Gestión</span>
                        </div>
                        <?php if($isAdmin || in_array('movimientos.index', $userModules)): ?>
                        <a href="<?php echo e(route('movimientos.index')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('movimientos.index') ? 'bg-white/5 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-white'); ?>">
                            <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('movimientos.index') ? 'text-emerald-400' : 'text-slate-500 group-hover:text-emerald-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
                            </svg>
                            <span class="font-medium">Movimiento Equipos</span>
                        </a>
                        <?php endif; ?>
                        <?php if($isAdmin || in_array('movimientos.consulta', $userModules)): ?>
                        <a href="<?php echo e(route('movimientos.consulta')); ?>" class="group flex items-center px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('movimientos.consulta') ? 'bg-white/5 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-white'); ?>">
                             <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('movimientos.consulta') ? 'text-emerald-400' : 'text-slate-500 group-hover:text-emerald-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-1 pt-2">
                        ...
                        <button id="config-toggle" class="w-full flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 group <?php echo e(request()->routeIs('admin.*') || request()->routeIs('maf.batches*') ? 'bg-white/5 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-white'); ?>">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.*') || request()->routeIs('maf.batches*') ? 'text-rose-400' : 'text-slate-500 group-hover:text-rose-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200 <?php echo e(request()->routeIs('admin.*') || request()->routeIs('maf.batches*') ? 'rotate-90 text-rose-400' : 'text-slate-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </button>
                        <div id="config-submenu" class="<?php echo e(request()->routeIs('admin.*') || request()->routeIs('maf.batches*') ? '' : 'hidden'); ?> space-y-1">
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('admin.users*') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('admin.users*') ? 'bg-rose-400' : 'bg-slate-600'); ?>"></span>
                                Usuarios
                            </a>
                            <a href="<?php echo e(route('admin.tienda-assignment.index')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('admin.tienda-assignment*') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('admin.tienda-assignment*') ? 'bg-rose-400' : 'bg-slate-600'); ?>"></span>
                                Asignación
                            </a>
                            <a href="<?php echo e(route('maf.batches.index')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('maf.batches*') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('maf.batches*') ? 'bg-rose-400' : 'bg-slate-600'); ?>"></span>
                                Importar MAF
                            </a>
                            <a href="<?php echo e(route('admin.categorias.index')); ?>" class="flex items-center pl-12 pr-4 py-2.5 text-sm rounded-lg transition-colors <?php echo e(request()->routeIs('admin.categorias*') ? 'text-white bg-white/5 font-medium' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                <span class="w-1.5 h-1.5 rounded-full mr-3 <?php echo e(request()->routeIs('admin.categorias*') ? 'bg-rose-400' : 'bg-slate-600'); ?>"></span>
                                Categorías
                            </a>
                        </div>
                    </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden bg-slate-50 relative z-0">
            ...
            <header class="bg-white/80 backdrop-blur-xl border-b border-slate-200 h-16 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <h2 class="text-xl font-bold text-slate-800 tracking-tight"><?php echo $__env->yieldContent('page-title', 'Inicio'); ?></h2>
                </div>
...
<?php /**PATH C:\WEB\MAFIT\resources\views/layouts/app.blade.php ENDPATH**/ ?>