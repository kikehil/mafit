<?php $__env->startSection('title', 'Captura Inventario'); ?>
<?php $__env->startSection('page-title', 'Captura Inventario'); ?>
...
function guardarNuevoEquipo() {
    ...
    fetch('<?php echo e(route("inventario.agregar-equipo")); ?>', {
        method: 'POST',
        headers: {
...
function buscarTienda() {
    ...
    fetch('<?php echo e(route("inventario.buscar-tienda")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function seleccionarTienda(cr, plaza) {
    ...
    // Obtener equipos
    fetch('<?php echo e(route("inventario.obtener-equipos")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function recopilarYEnviarDatos() {
    ...
    fetch('<?php echo e(route("inventario.guardar")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\WEB\MAFIT\resources\views/inventario/captura.blade.php ENDPATH**/ ?>